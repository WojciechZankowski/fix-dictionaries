...
import quickfix.*;
import quickfix.dukascopy.field.*;
...
public class MessageCracker {
	...
	/**
	 * Callback for FIXNotification message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	...
	/**
	 * Callback for FIXAccountInfo message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(AccountInfo message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	
	/**
	 * Callback for FIXInstrumentPositionInfo message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(InstrumentPositionInfo message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	
	/**
	 * Callback for FIXOvernightReport message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(OvernightReport message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	
	/**
	 * Callback for FIXActivationRequest message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(ActivationRequest message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	
	/**
	 * Callback for FIXActivationResponse message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(ActivationResponse message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	
	/**
	 * Callback for FIXAccountInfoRequest message.
	 *
	 * @param message
	 * @param sessionID
	 * @throws FieldNotFound
	 ...
	 * @throws IncorrectTagValue
	 */
	public void onMessage(AccountInfoRequest message, SessionID sessionID) throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
		throw new UnsupportedMessageType();
	}
	...
	public void crack44(Message message, SessionID sessionID)
		...
		else if (type.equals(Notification.MSGTYPE))
			onMessage((Notification)message, sessionID);
		else if (type.equals(AccountInfo.MSGTYPE))
			onMessage((AccountInfo)message, sessionID);
		else if (type.equals(InstrumentPositionInfo.MSGTYPE))
			onMessage((InstrumentPositionInfo)message, sessionID);
		else if (type.equals(OvernightReport.MSGTYPE))
			onMessage((OvernightReport)message, sessionID);
		else if (type.equals(ActivationRequest.MSGTYPE))
			onMessage((ActivationRequest)message, sessionID);
		else if (type.equals(ActivationResponse.MSGTYPE))
			onMessage((ActivationResponse)message, sessionID);
		else if (type.equals(AccountInfoRequest.MSGTYPE))
