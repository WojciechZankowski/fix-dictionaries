...
public class OrderCancelReplaceRequest extends Message {
	...
	public OrderCancelReplaceRequest(quickfix.dukascopy.field.OrigClOrdID origClOrdID, quickfix.dukascopy.field.ClOrdID clOrdID, quickfix.dukascopy.field.OrdType ordType) {
		this();
