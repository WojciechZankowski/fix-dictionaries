...
public class OrderMassStatusRequest extends Message {
	...
	public OrderMassStatusRequest(quickfix.dukascopy.field.MassStatusReqID massStatusReqID, quickfix.dukascopy.field.MassStatusReqType massStatusReqType) {
		this();
	...
	public void set(quickfix.dukascopy.field.MassStatusReqType value) {
		setField(value);
	}

	public quickfix.dukascopy.field.MassStatusReqType get(quickfix.dukascopy.field.MassStatusReqType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.dukascopy.field.MassStatusReqType getMassStatusReqType() throws FieldNotFound {
		return get(new quickfix.dukascopy.field.MassStatusReqType());
	}

	public boolean isSet(quickfix.dukascopy.field.MassStatusReqType field) {
		return isSetField(field);
	}
