...
public class QuoteRequest extends Message {
	...
	public QuoteRequest(quickfix.dukascopy.field.QuoteReqID quoteReqID) {
		this();
		setField(quoteReqID);
	}
	...
	public void set(quickfix.dukascopy.field.RFQReqID value) {
		setField(value);
	}

	public quickfix.dukascopy.field.RFQReqID get(quickfix.dukascopy.field.RFQReqID value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.dukascopy.field.RFQReqID getRFQReqID() throws FieldNotFound {
		return get(new quickfix.dukascopy.field.RFQReqID());
	}

	public boolean isSet(quickfix.dukascopy.field.RFQReqID field) {
		return isSetField(field);
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 140, 303, 537, 336, 625, 229, 54, 854, 38, 152, 516, 468, 469, 63, 64, 193, 192, 15, 232, 1, 660, 581, 555, 735, 692, 40, 62, 126, 60, 218, 220, 221, 222, 662, 663, 699, 761, 423, 44, 640, 235, 236, 701, 696, 697, 698, 453, 0};
	...
	public void set(quickfix.dukascopy.field.QuoteRequestType value) {
		setField(value);
	}

	public quickfix.dukascopy.field.QuoteRequestType get(quickfix.dukascopy.field.QuoteRequestType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.dukascopy.field.QuoteRequestType getQuoteRequestType() throws FieldNotFound {
		return get(new quickfix.dukascopy.field.QuoteRequestType());
	}

	public boolean isSet(quickfix.dukascopy.field.QuoteRequestType field) {
		return isSetField(field);
	}
	...
	public void set(quickfix.dukascopy.component.LegBenchmarkCurveData component) {
		setComponent(component);
	}

	public quickfix.dukascopy.component.LegBenchmarkCurveData get(quickfix.dukascopy.component.LegBenchmarkCurveData component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.dukascopy.component.LegBenchmarkCurveData getLegBenchmarkCurveData() throws FieldNotFound {
		return get(new quickfix.dukascopy.component.LegBenchmarkCurveData());
	}
	...
	public void set(quickfix.dukascopy.field.QuotePriceType value) {
		setField(value);
	}

	public quickfix.dukascopy.field.QuotePriceType get(quickfix.dukascopy.field.QuotePriceType value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.dukascopy.field.QuotePriceType getQuotePriceType() throws FieldNotFound {
		return get(new quickfix.dukascopy.field.QuotePriceType());
	}

	public boolean isSet(quickfix.dukascopy.field.QuotePriceType field) {
		return isSetField(field);
	}
