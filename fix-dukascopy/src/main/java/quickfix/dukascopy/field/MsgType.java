...
public class MsgType extends StringField {
	...
	public static final String NOTIFICATION = "U1";
	public static final String ACCOUNTINFO = "U2";
	public static final String INSTR_POS_INFO = "U3";
	public static final String OVERNIGHT_REPORT = "U4";
	public static final String ACTIVATION_REQUEST = "U5";
	public static final String ACTIVATION_RESPONSE = "U6";
	public static final String ACCOUNTINFO_REQUEST = "U7";
