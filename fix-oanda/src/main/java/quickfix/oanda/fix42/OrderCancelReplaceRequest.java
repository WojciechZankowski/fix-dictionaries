...
public class OrderCancelReplaceRequest extends Message {
	...
	public OrderCancelReplaceRequest(quickfix.oanda.field.OrigClOrdID origClOrdID, quickfix.oanda.field.ClOrdID clOrdID, quickfix.oanda.field.HandlInst handlInst, quickfix.oanda.field.Symbol symbol, quickfix.oanda.field.Side side, quickfix.oanda.field.TransactTime transactTime, quickfix.oanda.field.OrdType ordType) {
		this();
