...
public class NewOrderSingle extends Message {
	...
	public NewOrderSingle(quickfix.oanda.field.ClOrdID clOrdID, quickfix.oanda.field.Symbol symbol, quickfix.oanda.field.Side side, quickfix.oanda.field.TransactTime transactTime, quickfix.oanda.field.OrdType ordType) {
		this();
		setField(clOrdID);
		setField(symbol);
		setField(side);
