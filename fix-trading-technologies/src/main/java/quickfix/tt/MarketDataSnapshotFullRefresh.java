...
public class MarketDataSnapshotFullRefresh extends Message {
	...
	public MarketDataSnapshotFullRefresh(quickfix.tt.field.MDReqID mDReqID, quickfix.tt.field.Symbol symbol, quickfix.tt.field.SecurityType securityType, quickfix.tt.field.SecurityID securityID, quickfix.tt.field.SecurityExchange securityExchange) {
		this();
		setField(mDReqID);
		setField(symbol);
	...
	public static class NoMDEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {269, 270, 271, 290, 198, 16486, 16488, 16487, 346, 16489, 0};
