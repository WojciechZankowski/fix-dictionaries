...
public class OrderCancelReplaceRequest extends Message {
	...
	public OrderCancelReplaceRequest(quickfix.tt.field.ClOrdID clOrdID, quickfix.tt.field.OrderQty orderQty, quickfix.tt.field.Side side, quickfix.tt.field.OrdType ordType) {
		this();
		setField(clOrdID);
		setField(orderQty);
		setField(side);
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {311, 309, 310, 313, 316, 315, 314, 317, 308, 10456, 18212, 16624, 319, 10566, 0};
