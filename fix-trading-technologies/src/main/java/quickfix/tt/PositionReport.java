...
public class PositionReport extends Message {
	...
	public static final String MSGTYPE = "UAP";
	...
	public PositionReport(quickfix.tt.field.PosReqId posReqId, quickfix.tt.field.PosMaintRptId posMaintRptId, quickfix.tt.field.TotalNumPosReports totalNumPosReports, quickfix.tt.field.PosReqType posReqType) {
		this();
		setField(posReqId);
		setField(posMaintRptId);
		setField(totalNumPosReports);
		setField(posReqType);
	}
	...
	public void set(quickfix.tt.field.PosMaintRptId value) {
		setField(value);
	}

	public quickfix.tt.field.PosMaintRptId get(quickfix.tt.field.PosMaintRptId value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.tt.field.PosMaintRptId getPosMaintRptId() throws FieldNotFound {
		return get(new quickfix.tt.field.PosMaintRptId());
	}

	public boolean isSet(quickfix.tt.field.PosMaintRptId field) {
		return isSetField(field);
	}

	public boolean isSetPosMaintRptId() {
		return isSetField(16721);
	}

	public void set(quickfix.tt.field.TotalNumPosReports value) {
		setField(value);
	}

	public quickfix.tt.field.TotalNumPosReports get(quickfix.tt.field.TotalNumPosReports value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.tt.field.TotalNumPosReports getTotalNumPosReports() throws FieldNotFound {
		return get(new quickfix.tt.field.TotalNumPosReports());
	}

	public boolean isSet(quickfix.tt.field.TotalNumPosReports field) {
		return isSetField(field);
	}

	public boolean isSetTotalNumPosReports() {
		return isSetField(16727);
	}
	...
	public void set(quickfix.tt.field.RealizedPandL value) {
		setField(value);
	}

	public quickfix.tt.field.RealizedPandL get(quickfix.tt.field.RealizedPandL value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.tt.field.RealizedPandL getRealizedPandL() throws FieldNotFound {
		return get(new quickfix.tt.field.RealizedPandL());
	}

	public boolean isSet(quickfix.tt.field.RealizedPandL field) {
		return isSetField(field);
	}

	public boolean isSetRealizedPandL() {
		return isSetField(16210);
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {311, 309, 310, 313, 316, 315, 314, 317, 308, 18212, 10456, 16624, 319, 318, 10566, 0};
