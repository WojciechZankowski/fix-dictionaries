...
public class RelativePriceType extends StringField {

	static final long serialVersionUID = 20050617;

	public static final int FIELD = 16116;
	...
	public static final String Trigger = "5";
	
	public RelativePriceType() {
		super(16116);
	}

	public RelativePriceType(String data) {
		super(16116, data);
	}
